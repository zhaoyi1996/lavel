...
<form class="form-horizontal" action="/essay/store" method="post" enctype="multipart/form-data" role="form">
@csrf
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">文章标题</label>
		<div class="col-sm-10">
			<input type="text" class="form-control" name="essay_name" id="firstname" 
				   placeholder="请输入文章标题">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
            ...
            @foreach($Etypedata as $v)
                ...
                <option value="{{$v->e_id}}">{{$v->e_name}}</option>
            @endforeach
            </select>
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="radio"  name="is_sign" id="lastname" value="1" checked >普通
            <input type="radio"  name="is_sign" id="lastname" value="2" >置顶
		</div>
	</div>
    <div class="form-group">
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="essay_man" id="firstname" 
				   placeholder="请输入文章作者">
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="email" class="form-control" name="essay_email" id="firstname" 
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="essay_key" id="firstname" 
